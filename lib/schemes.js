...
let dbs = {
  newtables: {
    bot_: {
      id: "Suhail_Md",
      alive_text: "*𝒀𝒐𝒐 &user* \n*𝑩𝒍𝒂𝒄𝒌 𝒑𝒂𝒏𝒕𝒉𝒆𝒓 𝒊𝒔 𝒐𝒏𝒍𝒊𝒏𝒆* \n\n_𝑰 𝒂𝒎 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒃𝒐𝒕 𝒆𝒗𝒆𝒓_ \n\n*_Update Alive Message by adding text with Alive_* \n*SUPPORT US https://youtube.com/ibrahimaitech*",
    ...
    sck: {
      ...
      welcome: "false",
      goodbye: "false",
      welcometext: "*@user @pp Welcome  In @gname.....!!!!!🥷👇🏻☣* \n@desc\n\n *______________*\n  *Support us by Subscribing*\n*Youtube.com/ibrahimaiatech*",
      goodbyetext: "*@user @pp Left From @gname.....!!!!!🥷👆🏻☣* \n@desc\n *______________*\n  *Support us by Subscribing*\n*Youtube.com/ibrahimaiatech*",
      botenable: "true",
      antilink: "false",
      antiword: {},
      antifake: "false",
